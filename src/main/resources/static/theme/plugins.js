...
function fAfterSelected(y,m,d,e) {
    ...
    // alert(gdCtrl.id);
    if(gdCtrl.id=='txtEffectiveDate')
    {
         gContainer.document.getElementById("txtFinEffectiveDate").value=gContainer.document.getElementById(gdCtrl.id).value;
       //alert('worked ' +gContainer.document.getElementById("txtFinEffectiveDate").value);
      gContainer.document.getElementById(gdCtrl.id).onChange();
       // gdCtrl.form.submit();        
    }  
    
    
    
   //alert('date ' + document.getElementById("txtEffectiveDate").value );
 // triggerOthers(e);
}
